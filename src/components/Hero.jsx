...
const roles = ['Full Stack Developer', 'UI/UX Enthusiast', 'Problem Solver', 'Student Developer'];
            ...
            <div className="container">
                <div className="hero-content">
                    ...
                    <h1 className="hero-name">
                        Crafting digital<br />harmony <span className="highlight">through code.</span>
                    </h1>
                    <p className="hero-tagline">
                        <span className="typed-text">{text}</span>
                    </p>
                    <p className="hero-desc">
                        Full-stack developer focused on minimalist design systems and performant web experiences.
                        I bridge the gap between complex logic and calm aesthetics.
                    </p>
